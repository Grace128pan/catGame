...
def main_game():
    ...
    while running and turn < NUM_TURNS:
        if not paused:
            ...
            pause_button = draw_button("Pause", (WINDOW_SIZE - 400, WINDOW_SIZE + 10), (100, 30))
            continue_button = draw_button("Continue", (WINDOW_SIZE - 300, WINDOW_SIZE + 10), (100, 30))
            restart_button = draw_button("Restart", (WINDOW_SIZE - 200, WINDOW_SIZE + 10), (100, 30))
            exit_button = draw_button("Exit", (WINDOW_SIZE - 100, WINDOW_SIZE + 10), (100, 30))
