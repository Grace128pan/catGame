...
def main_game():
    ...
    while running and turn < NUM_TURNS:
        if not paused:
            ...
            button_spacing = 10
            pause_button = draw_button("Pause", (WINDOW_SIZE - 400, WINDOW_SIZE + 10), (90, 30))
            continue_button = draw_button("Continue", (WINDOW_SIZE - 300 + button_spacing, WINDOW_SIZE + 10), (90, 30))
            restart_button = draw_button("Restart", (WINDOW_SIZE - 200 + 2 * button_spacing, WINDOW_SIZE + 10), (90, 30))
            exit_button = draw_button("Exit", (WINDOW_SIZE - 100 + 3 * button_spacing, WINDOW_SIZE + 10), (90, 30))
